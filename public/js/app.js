	  ...
	  return {
	    ...
	    getComponent: function getComponent(location, cb) {
	      __webpack_require__.e/* nsure */(1, function (require) {
	        cb(null, __webpack_require__(200)("./" + fileName + '.jsx'));
	      });
	    }
	  };
	}

	_react2['default'].render(_react2['default'].createElement(_reactRouter.Router, { routes: rootRoute }), document.getElementById('main'));
